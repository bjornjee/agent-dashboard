...
const { readAllState, writeState } = require(path.join(hookRoot, 'packages', 'agent-state'));
const { claimWorktreeForPane } = require(path.join(hookRoot, 'packages', 'worktree-reconcile'));
