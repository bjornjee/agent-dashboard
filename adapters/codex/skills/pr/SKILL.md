...
4. From the Phase 1 changed-file list, take only test files this branch ADDED or MODIFIED (`*_test.go`, `*.test.{js,ts}`, `*.spec.*`, `test_*.py`, `*_test.py`). Never consider pre-existing tests.
