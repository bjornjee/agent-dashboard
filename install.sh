...
echo "=== Next steps ==="
echo ""
echo "  1. Register the Claude Code plugin (run this in any Claude Code session):"
echo ""
echo "     /plugin add bjornjee/agent-dashboard"
echo ""
echo "  2. Restart Claude Code sessions for hooks and skills to take effect."
echo ""
echo "  3. Run the dashboard in a tmux pane:"
echo ""
